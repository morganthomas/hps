...
let
  ...
  hcg-minus-src = builtins.fetchGit {
    url   = https://github.com/morganthomas/hcg-minus.git;
    rev   = "48491f044176a54d02460f8cb8da30126cd369a9";
    ref   = "master";
  };
  ...
  haskell-overlay = hself: hsuper: { 
    ...
    "hcg-minus" = hself.callCabal2nix "hcg-minus" hcg-minus-src {};
  };
  ...
  hps = pkgs.haskell.packages.${compilerjs}.callCabal2nix "hps" (gitignore ignorance ./.) {};
